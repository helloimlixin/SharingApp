...
public class ContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // When the contact is long clicked, start EditContactActivity.
        my_contacts.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int pos, long id) {
                ...
                // Display active borrowers on long click.
                ...
                contact_list.loadContacts(context); // reload contacts after long click event (mandatory)
